...
_READ_COMMANDS = {
    ...
    ("minimax", "packages"),
    ("minimax", "points"),
    ("minimax", "image", "config"),
    ("minimax", "image", "show"),
    ("minimax", "image", "list"),
    ("minimax", "audio", "pricing"),
    ("minimax", "audio", "voices"),
    ("minimax", "audio", "show"),
    ("minimax", "audio", "list"),
    ("minimax", "skill", "list"),
    ("team", "list"),
...
_WRITE_COMMANDS = {
    ...
    ("minimax", "create"),
    ("minimax", "cancel"),
    ("minimax", "image", "create"),
    ("minimax", "image", "cancel"),
    ("minimax", "image", "delete"),
    ("minimax", "image", "upload"),
    ("minimax", "audio", "create"),
    ("minimax", "audio", "cancel"),
    ("minimax", "audio", "delete"),
    ("minimax", "audio", "upload"),
    ("minimax", "audio", "voice-create"),
    ("minimax", "audio", "voice-delete"),
    ("minimax", "skill", "create"),
    ("minimax", "skill", "update"),
    ("minimax", "skill", "delete"),
    ("team", "create"),
    ("team", "update"),
    ("team", "delete"),
    ("team", "invite", "send"),
