...
class Runtime:
    ...
    @property
    def region(self) -> str:
        explicit = self.region_override or os.environ.get("COMPSHARE_REGION")
        if explicit:
            return explicit
        explicit_zone = self.zone_override or os.environ.get("COMPSHARE_ZONE")
    ...
    @property
    def zone(self) -> str:
        return self.zone_override or os.environ.get("COMPSHARE_ZONE") or DEFAULT_ZONE
